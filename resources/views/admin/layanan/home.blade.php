                ...
                <div class="middle-content container-xxl p-0">
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="tambahdataLabel">Tambah Layanan</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                        <svg> ... </svg>
                                    </button>
                                </div>
                                <form action="{{ route('add layanan') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                    ...
                    <div class="modal fade" id="ubahdata" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="tambahdataLabel">Ubah Layanan</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close">
                                        <svg> ... </svg>
                                    </button>
                                </div>
                                <form action="{{ route('edit layanan') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="id" id="idLayanan">
                                    <div class="modal-body">
                                        <div class="form-group mb-2">
                                            <label for="jenis" class="form-label">Jenis Layanan</label>
                                            <input type="text" id="jenisEdit" class="form-control"
                                                name="jenis">
                                        </div>
                                        <div class="form-group mb-2">
                                            <label for="gambar" class="form-label">Gambar</label> <br>
                                            ...
                                            @foreach ($layanan as $l)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <img src="{{ asset($l->gambar_path) }}"
                                                            style="border-radius: 10%; max-width: 150px;">
                                                    </td>
                                                    <td class="text-center">
                                                        <ul class="table-controls">
                                                            <li>
                                                                <a href="{{ route('detail layanan', $l->id) }}">
                                                            ...
                                                            <li>
                                                                <a data-bs-toggle="modal" data-bs-target="#ubahdata"
                                                                    ...
                                                                    onclick="editLayanan('{{ $l->id }}','{{ $l->jenis }}')"><svg
                                                            ...
                                                            <li>
                                                                <form style="display:inline" name="deleteForm-{{ $l->id }}"
                                                                    action="{{ route('delete layanan') }}"
                                                                    method="post">
                                                                    <a href="javascript:void(0);" class="bs-tooltip"
                                                                        onclick="deleteLayanan({{ $l->id }})"><svg
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            width="24" height="24"
                                                                            viewBox="0 0 24 24" fill="none"
                                                                            stroke="currentColor" stroke-width="2"
