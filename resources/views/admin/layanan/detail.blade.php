                    ...
                    <div class="modal fade" id="tambahdata" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('add layanan detail') }}" method="post"
                    ...
                    <div class="modal fade" id="ubahdata" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('edit layanan detail') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="id" id="idDetail">
                                    <div class="modal-body">
                                        <div class="form-group mb-2">
                                            <label for="judul" class="form-label">Judul</label>
                                            <input type="text" id="judulDetail" class="form-control"
                                                name="judul">
                                        </div>
                                        <div class="form-group mb-2">
                                            <label for="konten" class="form-label">Konten</label>
                                        ...
                                        <tbody>
                                            @foreach ($details as $detail)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea disabled style="border: none; background-color: transparent;" cols="100" rows="10">{{ $detail->konten }}</textarea>
                                                    </td>
                                                    <td class="text-center">
                                                            <img src="{{ asset($detail->gambar_path) }}"
                                                        ...
                                                        <ul class="table-controls">
                                                            <li>
                                                                <a data-bs-toggle="modal" data-bs-target="#ubahdata"
                                                                    ...
                                                                    onclick="editData('{{ $detail->id }}','{{ $detail->judul }}')"><svg
                                                            ...
                                                            <li>
                                                                <form style="display:inline" name="deleteForm-{{ $detail->id }}"
                                                                    action="{{ route('delete layanan detail') }}"
                                                                    method="post">
                                                                    <a href="javascript:void(0);" class="bs-tooltip"
                                                                        onclick="deleteData({{ $detail->id }})"><svg
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            width="24" height="24"
                                                                            viewBox="0 0 24 24" fill="none"
                                                                            stroke="currentColor" stroke-width="2"
