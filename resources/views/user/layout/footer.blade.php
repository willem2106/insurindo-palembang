      ...
      <div class="row my-4">
        ...
        <div class="col-lg-5 col-md-6 mb-4 mb-md-0">
          ...
          <p class="text-center">
            ...
            @lang('Insurindo adalah perusahan survei independen bertujuan  untuk memenuhi kebutuhan profesional jasa survei yang dibutuhkan dari industri bisnis Kelapa Sawit dan turunannya.')
        ...
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0" style="float:inherit">
          <h5 class="text-uppercase mb-4">Fitur </h5>

          <ul class="list-unstyled">
            <li class="mb-2">
              <a href="/" class="text-white" style="text-decoration: none"><i class="fas fa-atom pe-3"></i>Beranda</a>
            </li>
            <li class="mb-2">
              <a href="/about-us/sejarah" class="text-white" style="text-decoration: none"><i class="fas fa-atom pe-3"></i>Tentang Kami</a>
            </li>
            <li class="mb-2">
              <a href="/unit/kantor-pusat" class="text-white" style="text-decoration: none"><i class="fas fa-atom pe-3"></i>Unit</a>
            </li>
            <li class="mb-2">
              <a href="/layanan-kami" class="text-white" style="text-decoration: none"><i class="fas fa-atom pe-3"></i>Layanan Kami</a>
            </li>
            <li class="mb-2">
              <a href="/lowongan" class="text-white" style="text-decoration: none"><i class="fas fa-atom pe-3"></i>Lowongan</a>
            </li>
            <li class="mb-2">
              <a href="/kontak" class="text-white" style="text-decoration: none"><i class="fas fa-atom pe-3"></i>Kontak</a>
            </li>
          </ul>
        </div>
