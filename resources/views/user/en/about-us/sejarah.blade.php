...
@section('content')
    ...
    <div class="col text-center">
        <h2 class="text-center pt-4"><b>History Of Insurindo Palembang </b></h2>
    </div>
        <h4 class="text-center pt-5"> Know about Us in  <strong class="cBlue">"Insurindo Palembang"</strong> </h4>
