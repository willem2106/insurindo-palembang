...
@section('content')
    ...
    <h4 class="text-center pt-5">Visi dari <strong class="cBlue">“Insurindo Palembang”</strong></h4>
    ...
    <h4 class="text-center pt-5">Misi dari <strong class="cBlue">“Insurindo Palembang”</strong></h4>
