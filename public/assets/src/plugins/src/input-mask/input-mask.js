$(document).ready(function(){
    ...
    // Phone Number
    $("#ph-number").inputmask({mask:"(999) 99-999-999-999"});
    // Phone Number
    $("#ph-saya").inputmask({mask:"(+62) 99-999-999-999"});
    $(".ph-ikan").inputmask({mask:"(+62) 99-999-999-999"});

    // Currency
    $("#currency").inputmask({mask:"$999,9999,999.99"});
    $("#harga").inputmask({mask:"Rp 999.999,00"});
